...
# ─── Apply Breeze Dark theme (takes effect at first login) ────────────────────
# Breeze Dark is built into KDE — no extra packages required.
...
# Application widget style (Breeze, the default KDE style)
kwriteconfig6 --file kdeglobals --group KDE --key widgetStyle "Breeze"

# Icon theme (dark variant of the default Breeze icons)
kwriteconfig6 --file kdeglobals --group Icons --key Theme "breeze-dark"

# Window decoration (default Breeze decoration)
kwriteconfig6 --file kwinrc --group "org.kde.kdecoration2" \
    --key library "org.kde.breeze"
kwriteconfig6 --file kwinrc --group "org.kde.kdecoration2" \
    --key theme "Breeze"

# GTK 3/4 apps inside Plasma — Breeze-Dark from breeze-gtk (ships with plasma-meta)
